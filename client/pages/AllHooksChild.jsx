...
import { userContext, tripContext } from './AllHooksParent';
...
//-------AllHooksChild Component Definition--------------------------------------------------------------------------
...
const AllHooksChild = () => {
  ...
  useEffect(() => {
    setUser('Mark');
    return () => {
      console.log('I get executed when AllHooksChild unmounts or re-renders')
    }
  }, []);
